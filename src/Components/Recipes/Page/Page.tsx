...
class Page extends React.Component<PageProps, State>{
    ...
    updateRecipes(){
        console.log(this.props.foodStore.recipeQuery);
        this.props.foodStore.client.searchRecipes("", this.props.foodStore.recipeQuery, (error: any, data: any)=>{
            console.log(data);
            if(data){
        ...
        return (
            <div>
                <Container fluid>
                    ...
                    <Row>
                        <Col lg="3">
                            <Slider updateRecipe={this.updateRecipes} foodStore={this.props.foodStore}></Slider>
                        </Col>
                        <Col xs="10" lg="9">
